function [Robust] =Testformula(trajs,name)
...
%   formula=Atree.ftree;
%   phi=formula.get(1);
phi = '(alw_[0,1] (step[t]<pi1)) and (alw_[1,6] (step[t]<pi2)) ';
